package com.permanent_liufoxmail.pl.Host.Thread;

import android.util.Log;

import com.permanent_liufoxmail.pl.Host.ClientManager;
...
import static com.permanent_liufoxmail.pl.Host.ClientManager.sendMessageAll;
                ...
                new Thread(new Runnable()
                {
                    ...
                    public void run()
                    {
                        try
                        {
                            ...
                            while ((len = inputStream.read(buffer)) != -1)//如果成功读取了buffer
                            {
